...
function uhu_process_css($css, $theme) {
    ...
    $css = uhu_set_menubackcolor($css, $menubackcolor);
    ...
    $css = uhu_set_menuhovercolor($css, $menuhovercolor);
    ...
    $css = uhu_set_backimage($css, $backimage);
    ...
    $css = uhu_set_backposition($css,$backposition);
    ...
    $css = uhu_set_backcolor($css, $backcolor);
    ...
    $css = uhu_set_customcss($css, $customcss);
    
    return $css;
}

function uhu_set_menubackcolor($css, $menubackcolor) {
...
function uhu_set_menuhovercolor($css, $menuhovercolor) {
...
function uhu_set_backimage($css, $backimage) {
	global $OUTPUT;  
...
function uhu_set_backposition($css, $backposition = 'no-repeat', $tag = '[[setting:backposition]]'){
...
function uhu_set_backcolor($css, $backcolor) {
...
function uhu_set_logo($css, $logo) {
	global $OUTPUT;  
	$tag = '[[setting:logo]]';
	$replacement = $logo;
	$css = str_replace($tag, $replacement, $css);
...
function uhu_set_customcss($css, $customcss) {
